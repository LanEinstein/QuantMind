...
def test_shipped_bootstrap_lockfile_loads_and_denies_all() -> None:
    """The in-repo config/live_artifacts.lock.json must load and (at bootstrap)
    pin nothing — the deploy artifact itself is valid + safe."""

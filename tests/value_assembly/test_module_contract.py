"""AF-002 module contract: backend.value_assembly import isolation."""
...
import backend.value_assembly as pkg

FORBIDDEN_SUBPACKAGES = {"llm", "agents", "mirofish"}
_ROOT = pathlib.Path("backend/value_assembly")

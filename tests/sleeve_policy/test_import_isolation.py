"""AF-005 — sleeve_policy must stay a pure quant policy (no LLM/agents/mirofish)."""
...
_PKG = Path("backend/sleeve_policy")
...
def test_no_forbidden_imports() -> None:
    ...
    assert files, "sleeve_policy package has no modules to scan"
    for path in files:
